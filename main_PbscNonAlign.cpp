...
#define STR_APPNAME "NON-ALIGNED CASE (aka PBSC-N)"
#include "common.h"
...
const char* STR_USAGE =
    "Usage: pbsc_nonalign [-first_parameter <value>] ... [-last_parameter <value>] train_file [test_file] \n"
    "\n"
    "Required parameters: \n"
    ...
    "    -C              Constant multiplying the empirical risk (default=1.0) \n"
    ...
    "    -nIter          Maximum number of iterations (defaut=2e4) \n"
    ...
    "\n"
    "Examples: \n"
    "    (1) Use all default parameters on USvotes dataset, except the C value (decrease the effect of \n"
    "        KL-regularization): \n"
    "\n"
    "       ./pbsc_nonalign -C 100 USvotes_train.dat\n"
    "\n"
    ...
    "\n"
    "       ./pbsc_nonalign -kernel.gamma 0.5 -log 0 USvotes_train.dat \n"
    "\n"
    ...
    "\n"
    "       ./pbsc_nonalign -nIter 100 -writeStep 1 -log USvotes_100.log USvotes_train.dat USvotes_test.dat \n"
    ;
